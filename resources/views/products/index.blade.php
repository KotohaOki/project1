    ...
    <div class="search mt-5">
        ...
        @csrf
            ...
            <div class="col-sm-12 col-md-3">
                <input type="text" name="product_search" class="form-control" placeholder="商品名" value="{{ request('product_search') }}">
            </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ route('products.destroy', $product) }}" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <a href="#" id="{{ $product }}" onClick="return Check()">
